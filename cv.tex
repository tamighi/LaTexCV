  ...
  \begin{minipage}{0.45\linewidth}
    \begin{flushright}
      ...
      \begin{tabular}[t]{l@{}}
        ...
        \textbf{Github}: \href{https://github.com/tamighi}{github.com/tamighi} \\
        \textbf{Portfolio}: \href{https://tamighi.github.io/portfolio}{tamighi.github.io/portfolio}
      \end{tabular}
    \end{flushright}
    \hfill
  \end{minipage}
...
\begin{tcolorbox}[colframe=white, colback=white]
  ...
  \begin{minipage}[t]{0.60\linewidth}
    ...
    \section*{Personal Projects 
      \small\normalfont{
        \href{https://tamighi.github.io/portfolio}{\underline{(go to portfolio)}}
      }
    }
